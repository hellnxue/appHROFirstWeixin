...
<head>
    ...
    -->
<link rel="stylesheet" type="text/css" href="${ctx}/static/zhongqiu/css/style.css">
<script src="${ctx}/static/zhongqiu/js/jquery.min.js" type="text/javascript"></script>
<script type="text/javascript"  src="${ctx}/static/zhongqiu/js/jquery.bgiframe.min.js"></script>
<script type="text/javascript"  src="${ctx}/static/zhongqiu/js/jquery.validator.js"></script>
<script src="${ctx}/static/zhongqiu/js/int.com.js" type="text/javascript"></script>
<script src="${ctx}/static/zhongqiu/js/int.web.js" type="text/javascript"></script>

<script src="${ctx}/static/zhongqiu/js/jquery.easing.js" type="text/javascript"></script>
<script src="${ctx}/static/zhongqiu/js/jquery.waterfall.js" type="text/javascript"></script>
