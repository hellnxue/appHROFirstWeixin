...
<div class="login_form">
  ...
  <form action="" method="post">
    <div class="box_mk">
      ...
      <p class="loginbtn">
        <input type="submit" class="am-btn am-btn-danger am-btn-block am-btn-lg ygbtn" value="登 陆">
      </p>
      <!-- <div class="forget"><a href="" class="color3">忘记密码？</a></div> -->
    </div>
  </form>
</div>
