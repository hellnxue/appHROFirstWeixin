	...
	$.fn.scrollFix = function(options) {
		return this.each(function() {
			...
			$(window).scroll(function() {
			    ScrollHeight = parseInt($(document).height() - parseInt($(document).height() - $(opts.endPos).offset().top)), endfix = parseInt(ScrollHeight - outerHeight);
				var ScrollTop = $(window).scrollTop();
				//	console.log(endfix+'|'+ScrollTop);
				...
				if ((ScrollTop > toTop) && (ScrollTop < endfix)) {
					...
					obj.css({
						"position": "static",
						//"top": parseInt(endfix - outerHeight),
						"width": objWidth,
