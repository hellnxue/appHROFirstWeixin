...
$(".vip_tabbox").touchwipe({
		wipeLeft:function(){
			var scrollLeftvar = $(".vip_tabbox").scrollLeft()+$(window).width()*0.31;
	...
	$(".am-tabs-vipnav li").width($(window).width()*0.31).parent("ul").width($(window).width()*0.31*$(".am-tabs-vipnav li").length+5);
});
